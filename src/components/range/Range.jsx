...
function Range() {
  ...
  return (
    <div className="container px-3 mx-auto lg:px-0 font-poppins mt-[350px] md:mt-[50px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-5 lg:max-w-[1183px] mx-auto mt-[50px] place-items-center">
        {range.map((item) => (
        <div key={item.id}>
            <img className="w-full lg:max-w-[381px] max-h-[480px] rounded-[10px] object-cover" src={item.image} alt={item.name || "Range Image"} />
